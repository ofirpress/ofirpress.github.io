...
*Edit, June 2026:* If you are collecting benchmark tasks from a specific domain and find yourself needing to filter out some instances in order to make the benchmark harder, you are working with a task distribution that is too easy across the board. Sure, you can filter out some easier instances now, but that will only be a temporary measure. Your overall task distribution is too easy and you should probably move towards collecting tasks from a totally different and much harder domain.
